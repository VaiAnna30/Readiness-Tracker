...
*(Add screenshots of your UI here! Take a picture of the Side Panel open, the weakness detector triggering, and the streak tracker, and drag them into this section of your README later).*